...
<html lang="en-US">
	...
	<body>
		<div>
			Dear {{$name}},<br><br>
			My name is {{$user->first_name}} {{$user->last_name}} and I am a Junior at Germantown Friends School (GFS) in Philadelphia, PA. My team and I are organizing our schools’ first hackathon, <i>hackGFS</i>, which will be held in the spring of 2016.<br><br>
