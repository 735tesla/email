...
<html lang="en-US">
	...
	<body>
		<div>
			Dear {{$name}},<br><br>
			My name is {{$user->first_name}} {{$user->last_name}} and I am a Junior at Germantown Friends School (GFS) in Philadelphia, PA. My team and I are organizing our schools’ first hackathon, hackGFS, which will be held in the spring of 2016.<br><br>
			...
			Organizing a hackathon requires collaboration by many who share our vision and are willing to fund any part of the event. Partners are sponsors who are willing to donate $5,000+ automatically invited to give keynote speeches to help kick off hackGFS. All sponsors donating $1,000+ are invited to set up small booths and promote their company at hackGFS. Donors donating under $1,000 will have their logo up on the website and will be put on the donor banner. We believe that there is considerable opportunity for sponsors to gain exposure to a group of highly motivated and talented high schoolers, as well as be part of setting history: we are proud to be Philadelphia’s first high school hackathon.<br><br>
			...
			Noah Gansallo ‘17 - <a href="mailto:{{$user->email}}">{{$user->email}}</a><br><br>
