...
class SectionController extends BaseController {
	...
	{
		$section = "Hackathons are changing the world by inspiring technological innovation in young people. As technology plays a more integral role in our world, it becomes more and more important for companies to keep up with this change. Participating at this early stage by encouraging innovation will help make COMPANY a prominent catalyst in this technological advancement.";
	...
	{
		$section = "The brightest high school minds in computer science in the Greater Philadelphia area will be at hackGFS. If COMPANY donates to, or better yet sends a representative to attend hackGFS, students will be familiar with and remember you when they are looking to use a certain service or product while developing their skills in the future. Because of this exposure, we believe that sponsoring hackGFS now may result in huge benefits for COMPANY down the road.";
